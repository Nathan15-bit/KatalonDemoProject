...
formatter.step({
  "name": "User input \u003cusername\u003e \u0026 \u003cpassword\u003e",
  "keyword": "When "
});
formatter.step({
  "name": "Clicks on button login",
  "keyword": "And "
});
formatter.step({
  "name": "User redirected to homepage",
  "keyword": "Then "
});
formatter.examples({
  "name": "",
...
formatter.match({
  "location": "LoginSteps.user_in_login_page()"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "User input Admin \u0026 hUKwJTbofgPU9eVlw/CnDQ\u003d\u003d",
  "keyword": "When "
});
formatter.match({
  "location": "LoginSteps.user_input_username_Password(String,String)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "LoginSteps.clicks_on_button_login()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "LoginSteps.user_redirected_to_homepage()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "User input Test0000 \u0026 409CYFkz9v/8iWRY40PXdQ\u003d\u003d",
  "keyword": "When "
});
formatter.match({
  "location": "LoginSteps.user_input_username_Password(String,String)"

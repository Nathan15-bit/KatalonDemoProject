...
WebUI.click(findTestObject('Object Repository/Page_Overview/span_ContextAware'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_ContextAware/a_Instance Methods'))

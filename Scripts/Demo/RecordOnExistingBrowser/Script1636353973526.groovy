...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_LOGIN Panel_txtUsername (1)'), 'Admin')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_txtPassword (1)'), 'hUKwJTbofgPU9eVlw/CnDQ==')
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome Krish'))
